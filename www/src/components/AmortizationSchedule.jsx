...
export default function AmortizationSchedule({
  ...
  return (
    <div className="tab-body">
      {/* A sibling of `.panel`, not nested in it: on a phone this bar pins
          itself below the tab nav while the schedule beneath it scrolls,
          which needs a container spanning the whole tab -- see
          `.scenario-fields-collapsible`'s sticky rule in main.css. */}
      <ScenarioFields
