...
//! concrete backend. Mirrors `convex-ports` in the sibling `convex`
//! project — adapters (e.g. `mortgage-ext-redb`) depend *down* on this
//! crate, and callers (`mortgage-wasm`) depend on the trait, never on a
//! specific backend.
