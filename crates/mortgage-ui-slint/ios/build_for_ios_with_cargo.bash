...
#
# Vendored verbatim from slint-ui/slint's docs/scripts/build_for_ios_with_cargo.bash
# (see https://docs.slint.dev/latest/docs/slint/guide/platforms/mobile/ios/),
# invoked from project.yml's postCompileScripts.
